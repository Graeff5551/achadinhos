  ...
  app.post('/api/payment/pix', async (req, res) => {
    ...
    try {
      ...
      const payload = {
        ...
        // Payer info se a conta exigir (opcional na maioria das adquirentes via C7 v2)
      };
      ...
      // FALLBACK SEGURO: Se a API falhar (limite de quota ou erro de chave),
      // retornamos um PIX simulado para que o usuário finalize o fluxo de teste.
